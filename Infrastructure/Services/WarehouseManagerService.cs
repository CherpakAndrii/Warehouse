...
public class WarehouseManagerService : IWarehouseManagerService
{
    ...
    {
        Product changedQuantityProduct = _productsRepository.GetProduct(productChanges.ProductId)!;
        ...
        changedQuantityProduct.AvailableAmount += productChanges.ProductQuantityDifference;
    ...
    {
        Order sentOrder = _ordersRepository.GetOrder(orderRequest.OrderId)!;
        ...
        Product orderedProduct = _productsRepository.GetProduct(sentOrder.ProductId)!;
